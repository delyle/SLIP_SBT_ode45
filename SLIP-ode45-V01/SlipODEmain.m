...
% accomodate its use as a function (this file is a script), separating 
% the solving and plotting into two separate functions, namely, SLIPsim.m 
% and plotSLIPsim.m
