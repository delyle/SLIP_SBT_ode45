...
% FROM HERE ON, DOWNWARDS IS NO LONGER CONSIDERED POSITIVE. DOWNWARDS WAS
% ONLY CONSIDERED POSITIVE FOR THE PREVIOUS CALCULATIONS FOR THE "DROP" OF
% THE CENTER OF MASS DURING FLIGHT PHASE 2 BECAUSE IT WAS MORE CONVENIENT
% WHEN WORKING WITH THE KINEMATIC EQUATIONS.
...
Tgnd1 = roots([g/2 V01 -Y01]); %time to fall to ground (here, V01 is inputted as a positive, but we a negative is added here since we know it is a downward velocity)
